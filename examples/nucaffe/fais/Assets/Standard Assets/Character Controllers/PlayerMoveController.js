...
//	screenMovementForward = transform.forward;
//	screenMovementRight = transform.right;
}
...
function Update () {
	...
	if(isRemoteMove) {
		directionVector = new Vector3(moveX, 0, Input.GetAxis("Vertical"));
...
//		motor.inputJump = jump;
		...
		#if UNITY_IPHONE || UNITY_ANDROID || UNITY_WP8 || UNITY_BLACKBERRY
			directionVector = new Vector3(joystsickLeft.position.x, 0, joystickLeft.position.y);
		#else
		     // If NPC then horizontal is zero
		     if(this.isNPC) {
...
//		motor.inputJump = Input.GetButton("Jump");
	...
	motor.movementDirection = transform.rotation * directionVector;
